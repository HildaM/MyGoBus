...
func TestNewServer(t *testing.T) {
	serverBus := NewServer(":2024", "/_server_bus_", New())
	serverBus.Start()
...
func TestNewClient(t *testing.T) {
	clientBus := NewClient(":2024", "/_client_bus_", New())
	clientBus.Start()
...
func TestRegister(t *testing.T) {
	...
	serverBus := NewServer(":2024", serverPath, New())
...
func TestPushEvent(t *testing.T) {
	clientBus := NewClient("localhost:2024", "/_client_bus_", New())
...
func TestServerPublish(t *testing.T) {
	serverBus := NewServer(":2024", "/_server_bus_b", New())
	serverBus.Start()
	...
	clientBus.Subscribe("topic", fn, ":2024", "/_server_bus_b")
